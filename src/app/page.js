      ...
      <div className="hero min-h-screen">
        <div className="hero-content flex-col lg:flex-row gap-12 lg:gap-0">
          <div className="flex flex-col w-full lg:w-1/2">
            ...
            <Link href="/game" className="btn btn-primary"><FaGamepad className="text-2xl"/>Start New Game</Link>
          ...
          <img
            src={kitten}
            className="mask mask-heart w-full sm:w-1/2 rounded-lg shadow-2xl rotate-12 hover:animate-ping"
          />
        </div>
      </div>
    </main>
